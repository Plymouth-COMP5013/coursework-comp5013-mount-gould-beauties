...
def model_train(inputs, blocks, args, sum_path='./output/tensorboard'):
    ...
    dilation_factors = args.dilation_factors  # 🛠 اضافه شده: گرفتن dilation_factors
    ...
    # Define model loss
    train_loss, pred = build_model(x, n_his, Ks, Kt, blocks, keep_prob, dilation_factors=dilation_factors)
