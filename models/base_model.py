...
def build_model(inputs, n_his, Ks, Kt, blocks, keep_prob, dilation_factors):
    '''
    ...
    for i, channels in enumerate(blocks):
        x = st_conv_block(x, Ks, Kt, channels, i, keep_prob, act_func='GLU', dilation_factors=dilation_factors)
        Ko -= 2 * (Kt - 1)
